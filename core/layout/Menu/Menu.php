...
<aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="register_elderly"><i class="fas fa-user-plus"></i> <span Multi_lang="menu_register_elderly"></span></a></li>
        <li><a href="register_shop"><i class="fas fa-store"></i> <span Multi_lang="menu_register_shop"></span></a></li>
        <li><a href="list_elderly"><i class="fas fa-users"></i> <span Multi_lang="menu_list_elderly"></span></a></li>
        <li><a href="verify_doer"><i class="fas fa-check-circle"></i> <span Multi_lang="menu_verify_doer"></span></a></li>
        <li><a href="list_doers"><i class="fas fa-list"></i> <span Multi_lang="menu_list_doers"></span></a></li>
        <li><a href="list_requests"><i class="fas fa-clipboard-list"></i> <span Multi_lang="menu_list_requests"></span></a></li>
        <li><a href="rate_doers"><i class="fas fa-star"></i> <span Multi_lang="menu_rate_doers"></span></a></li>
        ...
        <li><a href="list_shops"><i class="fas fa-store"></i> <span Multi_lang="menu_list_shops"></span></a></li>
        <li><a href="list_products"><i class="fas fa-boxes"></i> <span Multi_lang="menu_list_products"></span></a></li>
        <li><a href="system_wallet"><i class="fas fa-wallet"></i> <span Multi_lang="menu_system_wallet"></span></a></li>
...
<li><a href="dashboard" class="active"><i class="fas fa-home"></i> <span Multi_lang="menu_home"></span></a></li>
        <li><a href="current_requests"><i class="fas fa-tasks"></i> <span Multi_lang="menu_current_requests"></span></a></li>
        <li><a href="list_all_requests"><i class="fas fa-list"></i> <span Multi_lang="menu_list_all_requests"></span></a></li>
...
<aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        <li class="menu-title" Multi_lang="main_menu"></li>
        <li><a href="dashboard" class="active"><i class="fas fa-home"></i> <span Multi_lang="menu_home"></span></a></li>
        <li><a href="submit_request"><i class="fas fa-plus-circle"></i> <span Multi_lang="menu_submit_request"></span></a></li>
        <li><a href="track_request"><i class="fas fa-search"></i> <span Multi_lang="menu_track_request"></span></a></li>
        <li><a href="rate_doer"><i class="fas fa-star-half-alt"></i> <span Multi_lang="menu_rate_doer"></span></a></li>
        <li><a href="wallet"><i class="fas fa-wallet"></i> <span Multi_lang="menu_wallet"></span></a></li>
...
<li><a href="list_all_products"><i class="fas fa-list"></i> <span Multi_lang="menu_list_all_products"></span></a></li>
        <li><a href="register_off_product"><i class="fas fa-ticket-alt"></i> <span Multi_lang="menu_register_off_product"></span></a></li>
        
        <li class="menu-title" Multi_lang="account_menu"></li>
        <li><a href="profile_shop"><i class="fas fa-store"></i> <span Multi_lang="menu_profile_shop"></span></a></li>
        <li><a href="logout" class="logout"><i class="fas fa-sign-out-alt"></i> <span Multi_lang="menu_logout"></span></a></li>
    </ul>
</aside>
';
