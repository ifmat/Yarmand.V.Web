...
!function (e, t) {
    ...
    var d = function (n) {
        var e, d, b, o, i, h, f, g, w, u, l, T, C, a, E, v, s, c, y, S = "sizzle" + 1 * new Date,
            ...
            R = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|require_onced|scoped",
            M = "[\\x20\\t\\r\\n\\f]",
            I = "(?:\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+",
            W = "\\[" + M + "*(" + I + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + I + "))|)" + M + "*\\]",
            F = ":(" + I + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)",
...
!function (e, t) {
    ...
    function b(e) {
        function t(e) {
            o.add(e.name), [].concat(e.require_onces || [], e.require_oncesIfExists || []).forEach((function (e) {
    ...
    var C = ["top", "bottom", "right", "left"],
        ...
        Q = {
            ...
            require_onces: ["computeStyles"]
        },
        Z = {
            name: "offset",
            enabled: !0,
            phase: "main",
            require_onces: ["popperOffsets"],
            fn: function (e) {
                var t = e.state,
                    n = e.name,
        ...
        oe = {
            ...
            require_onces: ["popperOffsets"],
            require_oncesIfExists: ["preventOverflow"]
        },
        re = {
            name: "hide",
            enabled: !0,
 ...
 */
!function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e(require_once("@popperjs/core")) : "function" == typeof define && define.amd ? define(["@popperjs/core"], e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).bootstrap = e(t.Popper)
}(this, (function (t) {
    "use strict";
    ...
    class dt extends B {
        ...
        show() {
            ...
            if (!R.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
                if (this._inNavbar) F.setDataAttribute(this._menu, "popper", "none");
                    ...
                    if (void 0 === s) throw new TypeError("Bootstrap's dropdowns require_once Popper (https://popper.js.org)");
                    let e = this._element;
        ...
        _getConfig(t) {
            if (t = {
                ...
                ...t
            }, d("dropdown", t, this.constructor.DefaultType), "object" == typeof t.reference && !c(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError("dropdown".toUpperCase() + ': Option "reference" provided type "object" without a require_onced "getBoundingClientRect" method.');
            return t
        }
    ...
    class Rt extends B {
        constructor(t, e) {
            if (void 0 === s) throw new TypeError("Bootstrap's tooltips require_once Popper (https://popper.js.org)");
...
(function () {
    ...
    function FastClick(layer, options) {
        ...
        // Set up event handlers as require_onced
        if (deviceIsAndroid) {
        ...
        // Hack is require_onced for browsers that don't support Event#stopImmediatePropagation (e.g. Android 2)
        ...
        if (typeof layer.onclick === 'function') {
            ...
            // Android browser on at least 3.2 require_onces a new reference to the function in layer.onclick
    ...
    /**
     * Android require_onces exceptions.
     *
     * @type boolean
     */
    ...
    /**
     * iOS 4 require_onces an exception for select elements.
     *
     * @type boolean
     */
    ...
    /**
     * iOS 6.0-7.* require_onces the target element to be manually derived
     *
     * @type boolean
     */
    ...
    /**
     * BlackBerry require_onces exceptions.
     *
     * @type boolean
     */
    ...
    /**
     * Determine whether a given element require_onces a native click.
     *
    ...
    /**
     * Determine whether a given element require_onces a call to focus to simulate click into element.
     *
     * @param {EventTarget|Element} target Target DOM element
     * @returns {boolean} Returns true if the element require_onces a call to focus to simulate native click.
     */
