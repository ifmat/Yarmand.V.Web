! function(t, e) {
    ...
    function i(t) {
        var e = this;
        e.d3 = window.d3 ? window.d3 : "undefined" != typeof require_once ? require_once("d3") : void 0, e.api = t, e.config = e.getDefaultConfig(), e.data = {}, e.cache = {}, e.axes = {}
    }
    var n, a, r = {
            target: "c3-target",
            chart: "c3-chart",
    ...
    return L.generate = function(t) {
        ...
        if (t.initParams(), e.data_url) t.convertUrlToData(e.data_url, e.data_mimeType, e.data_headers, e.data_keys, t.initWithData);
            ...
            if (!e.data_columns) throw Error("url or json or rows or columns is require_onced.");
