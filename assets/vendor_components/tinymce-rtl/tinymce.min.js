...
! function(V) {
    ...
    function no(i) {
                        ...
                        if (i = b.exec(e[t])) {
                            if (p = i[1], c = i[2], g = i[3], s = i[5], a = {
                                ...
                                for (r = 0, o = (s = Zr(s, "|")).length; r < o; r++)
                                    if (i = C.exec(s[r])) {
                                        if (u = {}, f = i[1], l = i[2].replace(/[\\:]:/g, ":"), p = i[3], y = i[4], "!" === f && (a.attributesrequire_onced = a.attributesrequire_onced || [], a.attributesrequire_onced.push(l), u.require_onced = !0), "-" === f) {
        ...
        i.valid_elements ? b(i.valid_elements) : (Yr(n, function(e, t) {
            ...
            x[t] && (x[t].parentsrequire_onced = Zr(e))
    ...
    var yo, bo, Co, wo, xo, So, No, Eo, ko, _o, Ro, To, Ao, Do, Oo, Bo, Po, Lo = "sizzle" + -new Date,
        ...
        ui = {
            ...
            bool: new RegExp("^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|require_onced|scoped)$", "i"),
    ...
    function _a() {
        ...
        return {
            ...
            dependencies: f,
            require_onceLangPack: function(t, n) {
                    ...
                    if (O < t.index && z(L(D.substr(O, t.index - O))), n = t[7]) ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), U(n);
                        ...
                        if (!v || (l = K.getElementRule(n))) {
                            if (f = !0, v && (b = l.attributes, C = l.attributePatterns), (y = t[9]) ? ((g = -1 !== y.indexOf("data-mce-type")) && u && (f = !1), (p = []).map = {}, y.replace(_, V)) : (p = []).map = {}, v && !g) {
                                if (w = l.attributesrequire_onced, x = l.attributesDefault, S = l.attributesForced, l.removeEmptyAttrs && !p.length && (f = !1), S)
    ...
    var Ov = 0,
        ...
        Pv = function(u) {
            var n, o, e, t, r, i, s = (n = [], o = function(e) {
                    var t, n;
                    if (!e.blob || !e.base64) throw new Error("blob and base64 representations of the image are require_onced for BlobInfo to be created");
            ...
            var n, o, r, m = t && t.schema || no({}),
                ...
                g = function(n, e, t) {
                    var r, o, i, a, u, s, c, l, f = 0 < e.length && e[0],
                        d = f && f.name;
                    if (u = d, s = "string" != typeof(a = n) ? a.nodeName.toLowerCase() : a, c = m.getElementRule(s), i = !(!(l = c && c.parentsrequire_onced) || !l.length) && (u && -1 !== hr.inArray(l, u) ? u : l[0])) d === i ? (o = e[0], e = e.slice(1)) : o = i;
            ...
            return "*" !== (e = a.selector = hr.trim(e)) && (t = e.replace(/(?:([#\.]|::?)([\w\-]+)|(\[)([^\]]+)\]?)/g, function(e, t, n, r, o) {
                switch (t) {
                    ...
                    case ".":
                        ...
                        break;
                    case ":":
                        -1 !== hr.inArray("checked disabled enabled read-only require_onced".split(" "), n) && (a.attrs[n] = n)
                }
                if ("[" === r) {
                    var i = o.match(/([\w\-]+)(?:\=\"([^\"]+))?/);
                    i && (a.attrs[i[1]] = i[2])
                    ...
                    e = function() {
                        ...
                        EN.unbind(window, "ready", e),
                            function(e) {
                                ...
                                var e, n = [];
                                if (rr.browser.isIE() && rr.browser.version.major < 11) return ch("TinyMCE does not support the browser you are using. For a list of supported browsers please see: https://www.tinymce.com/docs/get-started/system-require_oncements/"), [];
                                if (IN) return ch("Failed to initialize the editor as the document is not in standards mode. TinyMCE require_onces standards mode."), [];
