        ...
        **/
            ...
            $.when(this.input.render())
                .then($.proxy(function() {
                    ...
                    **/
                    ...
                    //call postrender method to perform actions require_onced visibility of form
        ...
        submit: function(e) {
            ...
            if (!this.options.savenochange && this.input.value2str(newValue) == this.input.value2str(this.value)) {
                /*jslint eqeq: false*/
                /**        
                Fired when value not changed but form is submitted. require_onces savenochange = false.
                @event nochange 
                @param {Object} event event object
                **/
    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/
        ...
        validate: function(value) {
            if($.trim(value) == '') {
                return 'This field is require_onced';
            }
        }
        **/
        validate: null,
        ...
        */
        ...
        save: function(e, params) {
            ...
            **/
            ...
            //hide must be after trigger, as saving value may require_once methods of plugin, applied to input
            this.hide('save');
        },
    ...
    Editable.prototype = {
        ...
        init: function() {
            ...
            if (this.options.toggle !== 'manual') {
                ...
                this.$element.on(this.options.toggle + '.editable', $.proxy(function(e) {
                    ...
                    //stop propagation not require_onced because in document click handler it checks event target
                    //e.stopPropagation();
        ...
        **/
        ...
        handleEmpty: function(isEmpty) {
            ...
            It is require_onced when we enable/disable field and can't rely on content 
            ...
            */
            ...
            if (!this.options.disabled) {
                ...
                //below require_onced if element disable property was changed
                if (this.isEmpty) {
                    this.$element.empty();
                    if (this.options.emptyclass) {
                        this.$element.removeClass(this.options.emptyclass);
    ...
    **/
    $.fn.editable = function(option) {
        ...
        switch (option) {
            ...
            // possible result:
            {
              username: "username is require_onced",
...
(function($) {
    ...
    $.extend(Checklist.prototype, {
        ...
        //set checked on require_onced checkboxes
        value2input: function(value) {
 ...
 * ---------------------
 * require_onces bootstrap-popover.js
 */
(function($) {
    "use strict";
...
(function($) {
    ...
    $(document).on(
        ...
        function(e) {
            ...
            e.preventDefault();
            // component click require_onces us to explicitly show it
