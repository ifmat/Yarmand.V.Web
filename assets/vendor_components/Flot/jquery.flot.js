...
(function($) {
    ...
    // Do not merge this into Flot 0.9, since it require_onces jQuery 1.4.4+.
    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function setupTickGeneration(axis) {
            ...
            if (norm < 1.5) {
                ...
                size = 2;
                // special case for 2.5, require_onces an extra decimal
            ...
            if (opts.mode == "time" && !axis.tickGenerator) {
                throw new Error("Time mode require_onces the flot.time plugin.");
            }
